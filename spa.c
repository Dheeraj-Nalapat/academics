...
inputarr(arr2,&r2,&c2);
while(1)
{ printf("1. SPARSE TO TUPLE MATRIX\n2:SUM OF TWO MATRIX\n3:TUPLE TRANSPOSE\n4:EXIT\nENTER YOUR CHOICE:");
  scanf("%d",&a);
  if(a==1)
  {printf("TUPLE MATRIX 1:\n");spartotup(arr1,r1,c1,tup1);printf("TUPLE MATRIX 2:\n");spartotup(arr2,r2,c2,tup2);}
  else if(a==2)
  {
    printf("SUM MATRIX:\n");
    tup_sum(tup1,tup2);
  ...
  {printf("TUPLE TRANSPOSE OF MATRIX 1:\n");tup_transpose(tup1,tupt1);printf("TUPLE TRANSPOSE OF MATRIX 2:\n");tup_transpose(tup2,tupt2);}
  else
  return 0;
